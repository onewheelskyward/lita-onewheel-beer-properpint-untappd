...
describe Lita::Handlers::OnewheelBeerProperpintUntappd, lita_handler: true do
  ...
  it 'shows the taps' do
    send_command 'pp'
    expect(replies.last).to eq("Proper Pint taps: 1) Ex Novo Brewing Record Skip  2) Unicorn Brewing Czech Pilsner  3) pFriem Family Brewers Bourbon Barrel Imperial Stout  4) Little Beast Brewing Bes  5) Fieldwork® Brewing Company Moahu  6) Rosenstadt Brewery Hop Pale Ale  7) Matchless Brewing ZZ Topaz  8) Bent Shovel Brewing Black Spade Stout  9) Oregon City Brewing Company Fallstreak  10) 54°40' Brewing Company River Road  11) North Jetty Brewing Flor De Yavari Sour Ale  12) North Jetty Brewing Leadbetter Red Scottish Ale  13) Urban Family Brewing Divine Scepter  14) Ninkasi Brewing Company r  15) Gigantic Brewing Company Mecha Red  17) 19 Acres Hard Cider Honeycrisp  18) Ruzzo - Hard Citrus Paradise Kick  19) Locust Cider Dark Cherry  20) Longdrop Cider Company Blueberry Pie  ) Yachats Brewing Heceta Lightkeeper")
  end
